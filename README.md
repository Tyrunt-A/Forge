...
- **Post-Game analysis** — pulls your most recent match (or any specific match ID) via the Riot Match Timeline API and reconstructs the real minute-by-minute chronology: wards placed, deaths, objectives, item timings. Claude connects cause and effect across the whole game in a single pass — e.g. a ward placed at minute 8 explaining a death at minute 13 — instead of just reading final stats. Falls back gracefully to end-game stats if timeline data isn't available for that match
...
- **Usage history** — remembers your Riot ID and your last few analyses between sessions, shown on the home screen
...
- Richer profile personalization (mastery data from prior accounts, manual overrides)
